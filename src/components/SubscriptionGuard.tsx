...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'laporan-bisnis'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'laporan-bisnis') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'laporan-bisnis'): boolean => {
    try {
